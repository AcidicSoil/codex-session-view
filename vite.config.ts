  ...
  return defineConfig({
    resolve: {
      alias: {
        ...
        'unicorn-magic/default.js': path.resolve(
          process.cwd(),
          'src/stubs/unicorn-magic.ts',
        ),
        'unicorn-magic/default': path.resolve(
          process.cwd(),
          'src/stubs/unicorn-magic.ts',
        ),
      },
    ...
    assetsInclude: ['**/*.md'],
    optimizeDeps: {
      exclude: ['ai-sdk-provider-gemini-cli', 'ai-sdk-provider-codex-cli', '@google/gemini-cli-core'],
      esbuildOptions: {
        loader: {
          '.md': 'text',
        },
