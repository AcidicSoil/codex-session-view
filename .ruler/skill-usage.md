...
- For every logic/backend task (refactors, features, tests, docs, workflows, integrations, etc.), first interpret the task under the applicable `src/AGENTS.md` rules, then scan `~/.codex/prompts/codex-skills/` and select the skill whose `SKILL.md` description and metadata most closely match the requested work.
