// path: src/server/lib/aiRuntime.ts
import {
...
// System Prompt for Hook Discovery (from conversation-analyzer.md)
...
export async function generateSessionAnalysis(options: AnalysisOptions): Promise<string> {
  ...
  if (definition.providerId === 'demo') {
    ...
    return options.analysisType === 'summary'
      ? '## Goals\n- (Demo) Demonstrate analysis.\n## Main changes\n- None.\n## Issues\n- None.\n## Follow-ups\n- Switch to a real model.'
      : 'chore(demo): switch to real model for inference';
  }
