...
export const SnippetTabsContent = ({
  ...
  <TabsContent
    asChild
    className={cn("mt-0 bg-background p-0 text-sm", className)}
    {...props}
  >
    <pre className="max-h-80 overflow-auto whitespace-pre-wrap break-words bg-background p-4 font-mono text-xs text-muted-foreground">
      {children}
    </pre>
  </TabsContent>
);
