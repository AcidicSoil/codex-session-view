...
import { filterOperatorVariants } from './variants';
...
export function FilterOperatorDropdown<T = unknown>({ field, operator, values, onChange }: FilterOperatorDropdownProps<T>) {
